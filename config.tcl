...
set defaultConfig {
    ...
    server     "openacs"
    serverroot	/var/www/openacs/$server
...
set servername		"Alter - Development oacs-5.10.0"
...
ns_section ns/parameters {
    ns_param	systemlog	${logroot}/error.log
    ...
    #
    # Rolling of logfile:
    ns_param	logrollsignal		on
    ns_param	logmaxbackup	10       ;# 10 is default
    ...
    ns_param  logusec           false    ;# add timestamps in microsecond (usec) resolution (default: false)
    ns_param  logusecdiff       false    ;# add timestamp diffs since in microsecond (usec) resolution (default: false)
